...
public class Readers2016 extends MultiPageApplet {
	...
	public static void main(String[] args) {
		...
		info("Running " + Readers2016.class.getName());
		// String[] options = { "--present", "--hide-stop","--bgcolor=#000000",
		String[] options = { "--hide-stop", "--bgcolor=#000000", Readers2016.class.getName() };
